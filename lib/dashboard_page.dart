    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.document_scanner_outlined, color: Color(0xFF22C55E)),
            tooltip: 'OCR 내역',
      ...
      child: Column(
        ...
        children: [
          ...
          if (total == 0)
            ...
            Row(
              children: [
                Expanded(child: _buildMedicationStat('전체', total.toString(), const Color(0xFF22C55E))),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.local_hospital_outlined, color: Color(0xFF22C55E), size: 20),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
