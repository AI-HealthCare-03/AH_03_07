  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.history, color: Color(0xFF22C55E)),
            tooltip: '대화 내역',
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                width: 44, height: 44,
                decoration: BoxDecoration(
                  color: _isSending ? Colors.grey : const Color(0xFF22C55E),
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(
            ...
            child: const Icon(Icons.chat_bubble_outline, color: Color(0xFF22C55E), size: 22),
          ),
          ...
          if (!isUser) ...[
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF22C55E).withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(16)),
              child: const Icon(Icons.smart_toy_outlined, color: Color(0xFF22C55E), size: 18),
            ),
            const SizedBox(width: 8),
          ],
